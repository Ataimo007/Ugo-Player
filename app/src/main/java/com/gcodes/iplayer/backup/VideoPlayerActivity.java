...
//    private final com.gcodes.iplayer.Player player  = com.gcodes.iplayer.Player.getInstance();
...
//            Log.d( "Subtitle_Activities", "The current window is " + player.getCurrentWindowIndex() );
//            showSubtitle();
//        });
//    }
//
...
//                showSubtitle();
//                Log.d( "Video_Player", "The current window is " + player.getCurrentWindowIndex() );
//            }
//        });
//    }
//
...
//        player.prepare( clone, false, false );
//        return clone;
//    }
//
...
//        factory = new DefaultDataSourceFactory(this, Util.getUserAgent(this, getResources().getString(R.string.app_name)));
...
//    }
//
//    public ExtractorMediaSource getMediaSource( String url )
//    {
...
////    {
////        ExtractorMediaSource videoSource = getVideoSource(video.getId());
...
//    {
//        SingleSampleMediaSource.Factory subFact = new SingleSampleMediaSource.Factory(factory);
...
//    {
//        File file = Subtitle.getSavedSubtitle( video, this );
//        if ( file == null )
//            return null;
...
//    {
//        Subtitle.downloadSubtitle( video, this);
//    }
//
...
//    }
//
//    private ExtractorMediaSource getVideoSource(String id )
//    {
...
//    }
//
//    private ExtractorMediaSource getVideoSource(long id )
//    {
//        Uri media = Uri.withAppendedPath(MediaStore.Video.Media.EXTERNAL_CONTENT_URI, String.valueOf( id ) );
//        Log.d( "Video_Player", "Video " + id );
//        Log.d( "Video_Player", "Video " + media.getPath() );
