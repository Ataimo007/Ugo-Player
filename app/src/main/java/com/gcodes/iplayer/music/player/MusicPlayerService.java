...
//        return super.onStartCommand(intent, flags, startId);
    ...
    public void onCreate() {
        ...
        NOTIFICATION_ID = getResources().getInteger( R.integer.notification_id );
        initNotification();
...
//    {
//        Uri media = Uri.withAppendedPath(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, String.valueOf( 12400 ) );
...
//                        return BitmapFactory.decodeResource( getResources(), R.drawable.ic_track_black_24dp );
////                        return null;
//                    }
//                });
//
...
//        });
//
//        manager.setPlayer(com.gcodes.iplayer.Player.getInstance().getPlayer());
//    }
