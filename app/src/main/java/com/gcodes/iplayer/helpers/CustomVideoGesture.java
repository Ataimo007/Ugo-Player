...
import com.gcodes.iplayer.video.player.VideoPlayerActivity.VideoGestureChangeListener;

public class CustomVideoGesture implements View.OnTouchListener
{
    ...
    public CustomVideoGesture(Context context, OnVideoGestureChangeListener onVideoGestureChangeListener,
                              @NonNull ExoVideoPlaybackControlView.PlayerAccessor playerAccessor, GestureAction action ) {
...
//        }
        ...
        if (length > 0) {
            ...
            seekAndShowJump(seek, time + jump, jump, jump > 0);
        }
    }
    ...
    private void seekAndShowJump(boolean seek, long jumpSize, long jump, boolean isFastForward) {
        if (onVideoGestureChangeListener != null) {
            onVideoGestureChangeListener.onShowSeekSize(jumpSize, isFastForward);
            if  ( onVideoGestureChangeListener instanceof VideoGestureChangeListener )
            {
                VideoGestureChangeListener listener = ( VideoGestureChangeListener ) onVideoGestureChangeListener;
                listener.onShowSeekSize( jumpSize, jump, isFastForward );
            }
        }
    }
